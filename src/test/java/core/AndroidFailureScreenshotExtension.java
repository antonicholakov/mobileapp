...
public class AndroidFailureScreenshotExtension implements TestWatcher {
    private static final Logger LOGGER = LoggerFactory.getLogger(AndroidFailureScreenshotExtension.class);
    ...
    private void takeScreenshot(ExtensionContext context) {
        ...
        if (testInstance.isPresent() && testInstance.get() instanceof BaseTestAndroid) {
            BaseTestAndroid test = (BaseTestAndroid) testInstance.get();
